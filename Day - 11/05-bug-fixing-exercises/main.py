...
# Try to fix the problem so that the last two lines can correctly get the maximal celsius value from the 
# function definition and convert that value to Fahrenheit.