...
# When the user enters the name of one of the waiting_list members, the program returns the index 
# of that name. For example, when the user enters "john", 0 is printed out.
...
# Enter name: zen
# Produces ValueError: 'zen' is not in list
