...
# The program depicted below consists of two Python files. The program tries to count and print out the 
# number of periods in the "Trees are good. Grass is green." . However, running the main.py file returns 
