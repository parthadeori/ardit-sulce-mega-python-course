...
# out what module and what function of that module you can use to generate random numbers. While it is easy for me 
# to provide some clues here on what module you should use, searching for information and becoming familiar with 
